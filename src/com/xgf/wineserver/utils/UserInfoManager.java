...
public class UserInfoManager {
	...
	public static void setUserInfo(Context context) {
		...
		UserInfoManager.userInfo.setAccount(userInfoPreferences.getString(USER_ACCOUNT_KEY, ""));
	...
	public static void saveUserInfo(Context context, User user) {
		if (null != user) {
			...
			userInfoSp.putString(USER_ACCOUNT_KEY, null == user.getAccount() ? "" : user.getAccount());
